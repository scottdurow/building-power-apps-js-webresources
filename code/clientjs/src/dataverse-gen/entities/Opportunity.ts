...
// Attribute constants
export const enum OpportunityAttributes {
  AccountId = "accountid",
  ...
  int_forecast_Base = "int_forecast_base",
  IsPrivate = "isprivate",
...
export interface Opportunity extends IEntity {
  ...
  // Forecast MoneyType Shows the forecasted revenue for an Opportunity.
  int_forecast?: number | null;
  // Forecast (Base) MoneyType Value of the Forecast in base currency.
